-- ============================================================================
-- Migration: 20260912122827_demo_relative_date_offsets.sql
-- Adds demo template date offsets and replaces provision_demo_session() so
-- cloned dates are relative to provisioning time.
-- Feature: feature/demo-relative-date-offsets
-- ============================================================================
...
INSERT INTO public.demo_template_date_offsets
  (template_row_id, template_table, day_offset)
VALUES
  -- Banana Stand: 3 past gigs
  ('00000000-0000-4000-8301-000000000001', 'gigs', -112),
  ('00000000-0000-4000-8301-000000000002', 'gigs', -76),
  ('00000000-0000-4000-8301-000000000003', 'gigs', -62),
  -- Banana Stand: 4 future gigs
  ('00000000-0000-4000-8301-000000000004', 'gigs', 27),
  ('00000000-0000-4000-8301-000000000005', 'gigs', 72),
  ('00000000-0000-4000-8301-000000000006', 'gigs', 107),
  ('00000000-0000-4000-8301-000000000007', 'gigs', 132),
  -- Modal Nodes: 3 past gigs
  ('00000000-0000-4000-8302-000000000001', 'gigs', -156),
  ('00000000-0000-4000-8302-000000000002', 'gigs', -107),
  ('00000000-0000-4000-8302-000000000003', 'gigs', -34),
  -- Modal Nodes: 4 future gigs
  ('00000000-0000-4000-8302-000000000004', 'gigs', 36),
  ('00000000-0000-4000-8302-000000000005', 'gigs', 82),
  ('00000000-0000-4000-8302-000000000006', 'gigs', 118),
  ('00000000-0000-4000-8302-000000000007', 'gigs', 163),
  ...
  -- Banana Stand financial entries
  ('00000000-0000-4000-8701-000000000001', 'financial_entries', -112),
  ('00000000-0000-4000-8701-000000000002', 'financial_entries', -76),
  ('00000000-0000-4000-8701-000000000003', 'financial_entries', -62),
  ('00000000-0000-4000-8701-000000000004', 'financial_entries', -113),
  ('00000000-0000-4000-8701-000000000005', 'financial_entries', -95),
  -- Modal Nodes financial entries
  ('00000000-0000-4000-8702-000000000001', 'financial_entries', -156),
  ('00000000-0000-4000-8702-000000000002', 'financial_entries', -34),
  ('00000000-0000-4000-8702-000000000003', 'financial_entries', -156),
  ('00000000-0000-4000-8702-000000000004', 'financial_entries', -65),
  ('00000000-0000-4000-8702-000000000005', 'financial_entries', -20)
