-- ROLLBACK: Restore pre-2026-08-01 behavior for update_song_metadata
-- Reason: POST-DEPLOY TEST 3 failed - musical_key non-overwrite logic broken
-- This restores the exact function Tony applied manually to production
