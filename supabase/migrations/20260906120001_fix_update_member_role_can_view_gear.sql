-- ============================================================================
-- Migration: Fix update_member_role to persist can_view_gear
-- Date: 2026-09-06
-- Branch: feature/band-gear-management
-- ============================================================================
--
-- Problem: The update_member_role RPC function does not update the
-- can_view_gear column when saving contributor permissions, causing
-- the Admin UI toggle to appear to save but revert on reload.
--
-- Fix: Add can_view_gear to the UPDATE statement's SET clause.
--
-- Impact: Enables Admins to grant view-only gear access to Contributors.
